<template>
    <div class="contenedor mt-10 md:mt-20 text-center" id="ceremonia">
        ...
        <div class="grid grid-cols-2 mt-2 md:mt-5">
            <div class="text-gray-700 text-right font-medium text-base md:text-3xl p-3 md:p-5 border-r md:border-r-2 border-gray-600">
                14 de octubre
            </div>
